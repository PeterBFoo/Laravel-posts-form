    ...
    <x-slot name="header">
        <div class="d-flex">
            <div class="p-2">
                ...
                <h2 class="font-semibold text-lg text-gray-500 leading-tight"> {{__('post.create-post')}} </h2>
            </div>
        </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form class="bg-white p-6 rounded-lg" method="post" action="{{ route("post.store") }}">
                        ...
                        <input class="w-1 border border-gray-400 p-2 rounded-lg" type="checkbox" name="expirable" id="expirable" {{ old('expirable') ? 'checked="checked"' : '' }}>
                        <br>
                        <label>
                        ...
                        <input class="w-full border border-gray-400 p-2 rounded-lg"
                               type="text" name="subtitle" id="subtitle" value="{{ old('subtitle') }}"
